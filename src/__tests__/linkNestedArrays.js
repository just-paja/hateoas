...
describe('HAL link resolver with nested arrays of links', () => {
  ...
  it('returns URL with translated string expansion for single templated link', () => {
    const links = {
      groups: [
        {
          href: 'http://example.com/api/users?all=true&projection={projection}&page={page}',
          templated: true
        }
      ]
    }
  ...
  it('returns non templated URL when given templated and non templated link without params', () => {
    const links = {
      groups: [
        {
          href: 'http://example.com/api/users/foo?all=true&projection={projection}&page={page}&size={size}',
          templated: true
        },
        {
          href: 'http://example.com/api/users?all=true',
  ...
  it('returns URL with query string with options matching params when given mutiple templated links with two params', () => {
    const links = {
      groups: [
        {
          href: 'http://example.com/api/users/foo?all=true&projection={projection}',
          templated: true
        },
        {
          href: 'http://example.com/api/users/bar?all=false&page={page}&size={size}',
          templated: true
        }
      ]
    }
  ...
  it('returns URL with query string with options matching params when given mutiple templated links with all matching and one non-matching param', () => {
    const links = {
      groups: [
        {
          href: 'http://example.com/api/users/foo?all=true&projection={projection}',
  ...
  it('returns URL with query string with most options matching params when given mutiple templated links with multiple params', () => {
    const links = {
      groups: [
        ...
        {
          href: 'http://example.com/api/users/bar?all=false&projection={projection}&page={page}',
          templated: true
        },
        {
          href: 'http://example.com/api/users/xyz?all=yes&projection={projection}&page={page}&size={size}',
          templated: true
        }
      ]
    }
